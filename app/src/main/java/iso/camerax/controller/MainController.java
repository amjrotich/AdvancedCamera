...
public class MainController {
    ...
    public static void setPreviewScaleType(PreviewView cameraPreview, Context context) {
        ...
        switch (scaleType) {
            case 1 -> cameraPreview.setScaleType(PreviewView.ScaleType.FILL_CENTER);
            case 3 -> cameraPreview.setScaleType(PreviewView.ScaleType.FIT_START);
            case 4 -> cameraPreview.setScaleType(PreviewView.ScaleType.FIT_CENTER);
            case 5 -> cameraPreview.setScaleType(PreviewView.ScaleType.FIT_END);
        }
    }
